...
module pipeline_controller (
    ...
    always_comb begin
        if (((mem1_mem2_mem_re_i || mem1_mem2_mem_we_i) && ~mem2_ack_i) || (csr_branch_i && (~mem1_ack_i || ~if2_ack_i || ~if1_ack_i))) begin
            {if1_stall_o, if2_stall_o, id_stall_o, exe_stall_o, mem1_stall_o, mem2_stall_o}       = 6'b111110;
            {if1_bubble_o, if2_bubble_o, id_bubble_o, exe_bubble_o, mem1_bubble_o, mem2_bubble_o} = 6'b000001;
        end else if (csr_branch_i) begin
            {if1_stall_o, if2_stall_o, id_stall_o, exe_stall_o, mem1_stall_o, mem2_stall_o}       = 6'b000000;
            {if1_bubble_o, if2_bubble_o, id_bubble_o, exe_bubble_o, mem1_bubble_o, mem2_bubble_o} = 6'b111111;
        end else if (~mem1_ack_i) begin
            {if1_stall_o, if2_stall_o, id_stall_o, exe_stall_o, mem1_stall_o, mem2_stall_o}       = 6'b111100;
            {if1_bubble_o, if2_bubble_o, id_bubble_o, exe_bubble_o, mem1_bubble_o, mem2_bubble_o} = 6'b000010;
        end else if (~branch_taken_i && (~if1_ack_i || ~if2_ack_i)) begin
            {if1_stall_o, if2_stall_o, id_stall_o, exe_stall_o, mem1_stall_o, mem2_stall_o}       = 6'b111000;
            {if1_bubble_o, if2_bubble_o, id_bubble_o, exe_bubble_o, mem1_bubble_o, mem2_bubble_o} = 6'b000100;
        end else if (~branch_taken_i) begin
            {if1_stall_o, if2_stall_o, id_stall_o, exe_stall_o, mem1_stall_o, mem2_stall_o}       = 6'b000000;
            {if1_bubble_o, if2_bubble_o, id_bubble_o, exe_bubble_o, mem1_bubble_o, mem2_bubble_o} = 6'b111000;
        end else if (
            ...
            {if1_stall_o, if2_stall_o, id_stall_o, exe_stall_o, mem1_stall_o, mem2_stall_o}       = 6'b110000;
            {if1_bubble_o, if2_bubble_o, id_bubble_o, exe_bubble_o, mem1_bubble_o, mem2_bubble_o} = 6'b001000;
            ...
            {if1_stall_o, if2_stall_o, id_stall_o, exe_stall_o, mem1_stall_o, mem2_stall_o}       = 6'b000000;
            {if1_bubble_o, if2_bubble_o, id_bubble_o, exe_bubble_o, mem1_bubble_o, mem2_bubble_o} = 6'b000000;
        end
    end
    ...
    //     // 无法用旁路解决的数据冲突：load-use ([ID]use, [EXE]load)，则插入�?个气泡到 ID/EXE
    //     end else if (
    //            id_exe_mem_re_i && id_exe_rf_wen_i && id_exe_rf_waddr_i != 0 
    //        && (id_exe_rf_waddr_i == id_rf_raddr_a_comb_i || id_exe_rf_waddr_i == id_rf_raddr_b_comb_i)
    //     ) begin
